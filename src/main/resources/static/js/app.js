...
function connect() {
    var socket = new SockJS('/online.bean.socket/gs-guide-websocket');
...
function updateNavBarInfo ()
{
	...
	url="config/updateNavBarInfo";
	invokePostAjax();

	url="fieldAttributor/updateNavBarInfo";
	invokePostAjax();

	url="projectPortfolio/updateNavBarInfo";
	invokePostAjax();

	url="projectDetail/updateNavBarInfo";
	invokePostAjax();

	url="projectList/updateNavBarInfo";
	invokePostAjax();

	url="userDetail/updateNavBarInfo";
	invokePostAjax();

	url="user/updateNavBarInfo";
	invokePostAjax();
